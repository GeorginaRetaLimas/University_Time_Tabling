...
#define __pyx_kp_u_Agregando_bloques_horarios __pyx_string_tab[1]
#define __pyx_kp_u_Agregando_cursos __pyx_string_tab[2]
#define __pyx_kp_u_Agregando_grupos __pyx_string_tab[3]
#define __pyx_kp_u_Agregando_profesores __pyx_string_tab[4]
#define __pyx_kp_u_Bloque __pyx_string_tab[5]
#define __pyx_kp_u_Curso __pyx_string_tab[6]
#define __pyx_kp_u_Iniciando_solver_C_timeout __pyx_string_tab[7]
#define __pyx_kp_u_N_A __pyx_string_tab[8]
#define __pyx_kp_u_No_se_encontr_solucin_completa __pyx_string_tab[9]
#define __pyx_kp_u_Profesor __pyx_string_tab[10]
#define __pyx_kp_u_Sin_Asignar __pyx_string_tab[11]
...
static PyMethodDef __pyx_mdef_17timetable_wrapper_1solve_timetable = {"solve_timetable", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_17timetable_wrapper_1solve_timetable, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_17timetable_wrapper_solve_timetable};
static PyObject *__pyx_pw_17timetable_wrapper_1solve_timetable(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "solve_timetable", 0) < (0)) __PYX_ERR(0, 25, __pyx_L3_error)
      if (!values[4]) values[4] = __Pyx_NewRef(((PyObject *)((PyObject*)__pyx_mstate_global->__pyx_float_60_0)));
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("solve_timetable", 0, 4, 5, i); __PYX_ERR(0, 25, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  5:
...
*/
  ...
  __pyx_t_3 = 1;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_2, __pyx_mstate_global->__pyx_kp_u_Agregando_bloques_horarios};
...
*/
  if (likely(PyList_CheckExact(__pyx_v_timeslots)) || PyTuple_CheckExact(__pyx_v_timeslots)) {
    ...
    __pyx_t_4 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_timeslots); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = (CYTHON_COMPILING_IN_LIMITED_API) ? PyIter_Next : __Pyx_PyObject_GetIterNextFunc(__pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 43, __pyx_L1_error)
  }
  for (;;) {
    if (likely(!__pyx_t_5)) {
...
*/
    ...
    __Pyx_GOTREF(__pyx_t_2);
    if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Lunes, __pyx_mstate_global->__pyx_int_1) < (0)) __PYX_ERR(0, 46, __pyx_L1_error)
    if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Martes, __pyx_mstate_global->__pyx_int_2) < (0)) __PYX_ERR(0, 46, __pyx_L1_error)
    if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Mircoles, __pyx_mstate_global->__pyx_int_3) < (0)) __PYX_ERR(0, 46, __pyx_L1_error)
    if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Jueves, __pyx_mstate_global->__pyx_int_4) < (0)) __PYX_ERR(0, 46, __pyx_L1_error)
    if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Viernes, __pyx_mstate_global->__pyx_int_5) < (0)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_XDECREF_SET(__pyx_v_dia_map, ((PyObject*)__pyx_t_2));
    __pyx_t_2 = 0;
...
*/
    __pyx_t_2 = __Pyx_PyObject_Dict_GetItem(__pyx_v_ts, __pyx_mstate_global->__pyx_n_u_day); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_6 = __Pyx_PyDict_GetItemDefault(__pyx_v_dia_map, __pyx_t_2, __pyx_mstate_global->__pyx_int_1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_XDECREF_SET(__pyx_v_dia_num, __pyx_t_6);
    __pyx_t_6 = 0;
...
*/
    __pyx_t_6 = __Pyx_PyObject_Dict_GetItem(__pyx_v_ts, __pyx_mstate_global->__pyx_n_u_id); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __Pyx_PyLong_As_int(__pyx_t_6); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L1_error)
...
*/
    __pyx_t_8 = __Pyx_PyLong_As_int(__pyx_v_dia_num); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L1_error)
 ...
 *         )
*/
    __pyx_t_6 = __Pyx_PyObject_Dict_GetItem(__pyx_v_ts, __pyx_mstate_global->__pyx_n_u_start_hour); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_9 = __Pyx_PyLong_As_int(__pyx_t_6); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyObject_Dict_GetItem(__pyx_v_ts, __pyx_mstate_global->__pyx_n_u_start_minute); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_10 = __Pyx_PyLong_As_int(__pyx_t_6); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 * 
*/
    __pyx_t_6 = __Pyx_PyObject_Dict_GetItem(__pyx_v_ts, __pyx_mstate_global->__pyx_n_u_end_hour); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_11 = __Pyx_PyLong_As_int(__pyx_t_6); if (unlikely((__pyx_t_11 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyObject_Dict_GetItem(__pyx_v_ts, __pyx_mstate_global->__pyx_n_u_end_minute); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_12 = __Pyx_PyLong_As_int(__pyx_t_6); if (unlikely((__pyx_t_12 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 *             dia_num,
*/
    __pyx_v_solver.agregarBloqueHorario(__pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12);
...
*/
  ...
  __pyx_t_3 = 1;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_6, __pyx_mstate_global->__pyx_kp_u_Agregando_profesores};
    __pyx_t_1 = __Pyx_PyObject_FastCall((PyObject*)__pyx_builtin_print, __pyx_callargs+__pyx_t_3, (2-__pyx_t_3) | (__pyx_t_3*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
...
*/
  if (likely(PyList_CheckExact(__pyx_v_professors)) || PyTuple_CheckExact(__pyx_v_professors)) {
    ...
    __pyx_t_4 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_professors); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
      ...
      for (;;) {
        if (likely(!__pyx_t_15)) {
          if (likely(PyList_CheckExact(__pyx_t_13))) {
            ...
            __pyx_t_2 = __Pyx_PyList_GetItemRefFast(__pyx_t_13, __pyx_t_14, __Pyx_ReferenceSharing_OwnStrongReference);
            ++__pyx_t_14;
          } else {
            {
            ...
            #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
            __pyx_t_2 = __Pyx_NewRef(PyTuple_GET_ITEM(__pyx_t_13, __pyx_t_14));
            #else
            __pyx_t_2 = __Pyx_PySequence_ITEM(__pyx_t_13, __pyx_t_14);
            #endif
            ++__pyx_t_14;
          }
...
*/
    ...
    for (; __pyx_t_26 != __pyx_v_solucion.end(); ++__pyx_t_26) {
